            ...
            local function on_attach(client, bufnr)
                ...
                local function goto_definition_new_tab()
                    ...
                    if #clients > 0 then
                        ...
                        local _client = clients[1]
                        if _client.offset_encoding then
                            encoding = _client.offset_encoding
                        end
                    end
                ...
                vim.keymap.set('n', '<leader>gH', '<cmd>ClangdSwitchSourceHeader<cr>', opts) -- Switch .h/.cpp same buffer
                ...
                vim.keymap.set('n', '<leader>di', vim.diagnostic.open_float, opts) -- Show diagnostic info (changed from de)
